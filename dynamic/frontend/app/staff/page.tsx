            ...
            >
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-14 h-14 rounded-full bg-slate-55 border border-slate-100 flex items-center justify-center font-bold text-[var(--primary-maroon)] text-lg flex-shrink-0">
